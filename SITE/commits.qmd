...
Visualização interativa do histórico de commits de todos os branches do projeto EcoHub. Por padrão, os útlimos 30 dias são apresentados automaticamente, mas é possível alterar para intervalos maiores ou menores.
...
<div class="controls">
  ...
  <div class="control-group">
    <label for="date-from">Início:</label>
    <input type="date" id="date-from">
  </div>
  
  <div class="control-group">
    <label for="date-to">Fim:</label>
    <input type="date" id="date-to">
  </div>
  
  <button class="btn-reset" style="background:#065f46" onclick="applyFilters()">Consultar</button>
...
<div class="nav-tabs">
  <button class="nav-tab active" onclick="switchTab('table')">📊 Tabela</button>
...
<script>
  // Opcional: defina um token público para evitar rate limit da API do GitHub
