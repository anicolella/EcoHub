...
# Junção e adição de anos
AL18 <- rbind(MRT1_2018, MRT2_2018, MRT3_2018, MRT4_2018)
AL18$ano <- 2018
AL22 <- rbind(MRT1_2022, MRT2_2022, MRT3_2022, MRT4_2022)
AL22$ano <- 2022
AL24 <- rbind(MRT1_2024, MRT2_2024, MRT3_2024, MRT4_2024)
AL24$ano <- 2024
