#roraima
# Data extraction from ramt_sr25_2018.pdf
library(tidyverse)
# MRT: MRT-1
...
# Consolidação dos dados de 2018
RR2018 <- rbind(MRT1_2018, MRT2_2018)

# Data extraction from RAMT_SRRR_2022.pdf
...
RR2022 <- rbind(MRT1_2022, MRT2_2022)

# Data extraction from RR_PPR_2024.pdf
...
# Consolidação dos dados de 2024
RR2024 <- rbind(MRT1_2024, MRT2_2024)
RR2024$ano <- 2024
RR2022$ano <- 2022
RR2018$ano <- 2018
...
write.csv2(RRTEMPORAL, file = "C:/Users/jodom/OneDrive/Área de Trabalho/RRTEMPO.csv")
