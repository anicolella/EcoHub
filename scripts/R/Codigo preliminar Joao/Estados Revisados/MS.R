...
# Tabela 5. Preços Referenciais para o Mercado Regional de Terras de Dourados (MRT-1)
...
# Tabela 6. Preços Referenciais para o Mercado Regional de Terras de Três Lagoas (MRT-02)
...
# Tabela 7. Preços Referenciais para o Mercado Regional de Terras Campo Grande (MRT-03)
...
# Tabela 8. Preços Referenciais para o Mercado Regional de Terras de Coxim (MRT-04)
...
# Tabela 9. Preços Referenciais para o Mercado Regional de Terras de Chapadão do Sul (MRT-05)
...
# Tabela 10. Preços Referenciais para o Mercado Regional de Terras de Paranaíba (MRT-06)
...
# Tabela 11. Preços Referenciais para o Mercado Regional de Terras de Sidrolândia (MRT-07)
...
# Tabela 12. Preços Referenciais para o Mercado Regional de Terras de Maracaju (MRT-08)
...
# Tabela 13. Preços Referenciais para o Mercado Regional de Terras de Corumbá (MRT-09)
...
# Tabela 14. Preços Referenciais para o Mercado Regional de Terras de Navirai (MRT-10)
...
# Tabela 15. Preços Referenciais para o Mercado Regional de Terras de Nova Andradina (MRT-11)
MRT11_2017 <- data.frame(
...
# Tabela 16. Preços Referenciais para o Mercado Regional de Terras de Ivinhema (MRT-12)
MRT12_2017 <- data.frame(
...
# Tabela 17. Preços Referenciais para o Mercado Regional de Terras de Aquidauana (MRT-13)
MRT13_2017 <- data.frame(
...
# Tabela 18. Preços Referenciais para o Mercado Regional de Terras de Jardim (MRT-14)
MRT14_2017 <- data.frame(
...
# Tabela 19. Preços Referenciais para o Mercado Regional de Terras de Iguatemi (MRT-15)
MRT15_2017 <- data.frame(
...
# Consolidar todos os data.frames em uma única tabela
MS2017 <- rbind(
  MRT1_2017, MRT2_2017, MRT3_2017, MRT4_2017, MRT5_2017, MRT6_2017,
  MRT7_2017, MRT8_2017, MRT9_2017, MRT10_2017, MRT11_2017, MRT12_2017,
  MRT13_2017, MRT14_2017, MRT15_2017
)



# Tabela Referencial de Preços de Terra (Ano 2018)
...
MS2018<- rbind(MRT01_2018, MRT02_2018, MRT03_2018, MRT04_2018, MRT05_2018, MRT06_2018, MRT07_2018, MRT08_2018, MRT09_2018, MRT10_2018, MRT11_2018, MRT12_2018, MRT13_2018, MRT14_2018, MRT15_2018)

# Consolidar todos os data.frames em uma única tabela


# Tabela 06. Preços Referenciais para o Mercado Regional de Terras de Dourados (MRT-1)
...
# Tabela 07. Preços Referenciais para o Mercado Regional de Terras de Três Lagoas (MRT-02)
...
# Tabela 08. Preços Referenciais para o Mercado Regional de Terras Campo Grande (MRT-03)
...
# Tabela 09. Preços Referenciais para o Mercado Regional de Terras de Coxim (MRT-04)
...
# Tabela 10. Preços Referenciais para o Mercado Regional de Terras de Chapadão do Sul (MRT-05)
...
# Tabela 11. Preços Referenciais para o Mercado Regional de Terras de Paranaíba (MRT-06)
...
# Tabela 12. Preços Referenciais para o Mercado Regional de Terras de Sidrolândia (MRT-07)
...
# Tabela 13. Preços Referenciais para o Mercado Regional de Terras de Maracaju (MRT-08)
...
# Tabela 14. Preços Referenciais para o Mercado Regional de Terras de Corumbá (MRT-09)
...
# Tabela 15. Preços Referenciais para o Mercado Regional de Terras de Navirai (MRT-10)
...
# Tabela 16. Preços Referenciais para o Mercado Regional de Terras de Nova Andradina (MRT-11)
MRT11_2020 <- data.frame(
...
# Tabela 17. Preços Referenciais para o Mercado Regional de Terras de Ivinhema (MRT-12)
MRT12_2020 <- data.frame(
  mrt = "Ivinhema, Deodápolis, Fátima do Sul, Glória de Dourados, Jatei, Novo Horizonte do Sul e Vicentina",
...
# Tabela 18. Preços Referenciais para o Mercado Regional de Terras de Aquidauana (MRT-13)
MRT13_2020 <- data.frame(
  mrt = "Aquidauana e Miranda",
...
# Tabela 19. Preços Referenciais para o Mercado Regional de Terras de Jardim (MRT-14)
MRT14_2020 <- data.frame(
  mrt = "Jardim, Anastácio, Antonio João, Bela Vista, Bodoquena, Bonito, Guia Lopes da Laguna e Nioaque",
...
# Tabela 20. Preços Referenciais para o Mercado Regional de Terras de Iguatemi (MRT-15)
MRT15_2020 <- data.frame(
  mrt = "Iguatemi, Coronel Sapucaia, Eldorado, Itaquarai, Japorã, Mundo Novo, Paranhos, Sete Quedas e Tacuru",
...
# Consolidar todos os data.frames em uma única tabela
MS2020 <- rbind(
  MRT1_2020, MRT2_2020, MRT3_2020, MRT4_2020, MRT5_2020, MRT6_2020,
  MRT7_2020, MRT8_2020, MRT9_2020, MRT10_2020, MRT11_2020, MRT12_2020,
  MRT13_2020, MRT14_2020, MRT15_2020
)
...
write.csv2(MSTEMPORAL, file = "C:/Users/jodom/OneDrive/Área de Trabalho/MSTEMPO.csv")
