...
# Tabela de Preços Referenciais de Terras (PPR) - Ano 2022
# Extração de dados do documento PPR/SR08/SP/2022 - Versão Final Corrigida

# MRT1: Mercado Regional de Terras Noroeste
# Tabela de Preços Referenciais de Terras (PPR) - 2022
...
# Consolidacao final dos data.frames
...
write.csv(SPTEMPO, 
          file = "C:/Users/jodom/OneDrive/Área de Trabalho/SPTEMPO.csv"
          )
