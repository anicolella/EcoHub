...
GO2017 <- rbind(MRT1_2017, MRT10_2017, MRT2_2017, MRT3_2017, MRT4_2017, MRT5_2017, MRT6_2017, MRT7_2017, MRT8_2017, MRT9_2017)
...
# Exemplo de Modelo de Data.frame
# Data frame para MRT - VALE DO ARAGUAIA
# MRT 01: VALE DO ARAGUAIA
...
GO2017$ano <- 2017
GO24$ano <- 2024
GOTEMPORAL <- rbind(GO24, GO22, GO2017)
GOTEMPORAL$estado <- 62
GOTEMPORAL$região <- "Centro-Oeste"

# Este código deve ser adicionado após a criação do dataframe 'GOTEMPORAL
...
write.csv2(GOTEMPORAL, file = "C:/Users/jodom/OneDrive/Área de Trabalho/GOTEMPO.csv")
