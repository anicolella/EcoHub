...
# Anos de referência: 2015, 2016, 2017

# Tabela de Preços Referenciais de Terras para o MRT ZH Vale do Paraiba (2017)
MRT_ValeDoParaiba_2017 <- data.frame(
...
# Tabela de Preços Referenciais de Terras para o MRT ZH Leste Fluminense (2017)
MRT_LesteFluminense_2017 <- data.frame(
...
# Tabela de Preços Referenciais de Terras para o MRT ZH Metropolitana (2017)
MRT_Metropolitana_2017 <- data.frame(
...
# Tabela de Preços Referenciais de Terras para o MRT ZH Nordeste Fluminense (2017)
MRT_NordesteFluminense_2017 <- data.frame(
...
# Tabela de Preços Referenciais de Terras para o MRT ZH Lagos (2017)
MRT_Lagos_2017 <- data.frame(
  mrt = "ZH Lagos",
  tipologia_de_uso = c(
    "Uso Indefinido (média geral)",
    "Pecuária",
...
# Consolidando todos os data.frames em uma única tabela
RJ17 <- rbind(
  MRT_ValeDoParaiba_2017,
  MRT_LesteFluminense_2017,
  MRT_Serrana_2017,
  MRT_Metropolitana_2017,
  MRT_NordesteFluminense_2017,
  MRT_Lagos_2017
)
...
# MRT 1: Nordeste Fluminense
MRT_Nordeste_Fluminense_2022 <- data.frame(
  mrt = "ZH Nordeste Fluminense",
...
# MRT 2: Leste Fluminense
MRT_Leste_Fluminense_2022 <- data.frame(
  mrt = "ZH Leste Fluminense",
...
# MRT 3: Serrana ##voltar aqui####
MRT_Serrana_2022 <- data.frame(
  mrt = "ZH Serrana",
...
# MRT 5: Vale do Paraíba
MRT_Vale_do_Paraiba_2022 <- data.frame(
...
# MRT 6: Metropolitana
MRT_Metropolitana_2022 <- data.frame(
  mrt = "ZH Metropolitana",
...
RJ22 <- rbind(
  MRT_Nordeste_Fluminense_2022,
  MRT_Leste_Fluminense_2022,
  MRT_Serrana_2022,
  MRT_Lagos_2022,
  MRT_Vale_do_Paraiba_2022,
  MRT_Metropolitana_2022
)

RJ22$ano <- 2022
RJTEMPO <- rbind(RJ17, RJ22)
RJTEMPO$estado <- 43
RJTEMPO$regiao <- "sudeste"
...
write.csv(RJTEMPO, file = "C:/Users/jodom/OneDrive/Área de Trabalho/RJTEMPO.csv")
