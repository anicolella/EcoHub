...
As linhas tracejadas são regressões lineares no modelo LOG-LOG para verificar a elasticidade do número de observações à área, utilizando os níveis categóricos 0 e 1, conforme explicado nos scatter plots anteriores, o resultado dos betas demonstra uma oferta inelástica de informação em relação a área, como visto no data-frame anterior.
