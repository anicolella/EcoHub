...
MRT2302_2024 <- data.frame(
  ...
  origem =  "Canindé do São Francisco, Poço Redondo, Monte Alegre de Sergipe, Porto da Folha e
...
MRT2304_2024 <- data.frame(
  ...
  vti_minimo = c(
    1667.60, 16676.40, 2470.72, 10862.21, 19309.92, 16676.40, 12594.52,
...
MRT2306_2024 <- data.frame(
  ...
  nivel = c(0, 1, 1, 1, 2, 2, 2, 2),
  vti_media = c(
    55485.66, 67091.06, 30776.03, 29712.07, 89067.90, 40993.58, 30776.03,
    29712.07
  ),
  vti_minimo = c(
    21282.92, 48407.99, 25385.14, 23705.91, 72746.43, 29290.44, 25385.14,
    23705.91
  ),
  vti_maximo = c(
    120832.14, 85774.14, 36166.92, 35718.24, 105389.36, 52696.71, 36166.92,
    35718.24
  ),
  vtn_media = c(
    37834.52, 44361.76, 23594.81, 18508.79, 54894.65, 31853.94, 23594.81,
    18508.79
  ),
  vtn_minimo = c(
    15566.19, 32499.88, 19577.56, 15732.47, 43802.82, 22135.70, 19577.56,
    15732.47
  ),
  vtn_maximo = c(
    75408.94, 56223.63, 27612.06, 21285.11, 65986.48, 41572.19, 27612.06,
    21285.11
  ),
  origem = "Carira, Frei Paulo, Pinhão, Pedra Mole, Macambira, Campo do Brito, São Domingos,
Areia Branca, Itabaiana, Malhador e Moita Bonita"
)
...
MRT2307_2024 <- data.frame(
  ...
  nivel = c(0, 1, 1, 1, 2, 2, 2, 2),
  vti_media = c(
    17460.72, 28872.89, 21190.42, 14874.60, 28872.89, 19470.08, 26446.28,
    17492.95
  ),
  vti_minimo = c(
    5642.44, 24541.95, 15539.11, 10481.75, 24541.95, 12336.79, 22479.34,
    12647.67
  ),
  vti_maximo = c(
    38016.53, 33203.82, 26841.74, 19267.46, 33203.82, 26603.36, 30413.22,
    22338.78
  ),
  vtn_media = c(
    15138.48, 23870.94, 18769.55, 12273.54, 23870.94, 17747.81, 19961.58,
    15061.40
  ),
  vtn_minimo = c(
    4661.98, 20252.74, 13613.01, 8833.23, 20252.74, 11097.44, 16807.04,
    10899.07
  ),
  vtn_maximo = c(
    30033.06, 27489.14, 23926.10, 15713.86, 27489.14, 24398.19, 23116.13,
    19223.72
  ),
...
MRT2308_2024 <- data.frame(
  ...
  vti_media = c(
    24800.71, 38756.97, 7207.31, 26356.32, 21835.32, 40460.76, 24936.93,
    30332.82, 23245.54, 28347.21, 17757.88
  ),
  vti_minimo = c(
    5831.07, 32824.95, 5831.07, 20626.40, 17761.66, 34391.65, 21196.26,
    22053.71, 18685.69, 23736.19, 14594.06
  ),
  vti_maximo = c(
    52851.44, 44688.99, 8583.55, 32086.25, 26008.88, 46529.88, 28677.46,
    38611.93, 27805.39, 32958.23, 20921.71
  ),
  vtn_media = c(
    21530.46, 32670.40, 6984.67, 21155.90, 18993.35, 32670.40, 21087.50,
    24845.69, 20114.41, 24466.04, 15672.85
  ),
  vtn_minimo = c(
    5742.49, 27769.84, 5742.49, 17102.52, 15430.53, 27769.84, 17924.37,
    18961.38, 16416.92, 20093.32, 12969.58
  ),
  vtn_maximo = c(
    48865.80, 37570.96, 8226.85, 25209.27, 22556.17, 37570.96, 24250.62,
    30730.01, 23811.89, 28838.75, 18376.12
  ),
  origem = "Tomar do Geru, Itabaianinha, Pedrinhas, Boquim, Salgado, Itaporanga d’Ajuda,
