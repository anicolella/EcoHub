#Sergipe
# Data extraction from ppr_sr23_2017.pdf

# MRT: Alto Sertão Sergipano
MRTAltoSertaoSergipano_2017 <- data.frame(
  mrt = "Alto Sertão Sergipano",
  tipologia_de_uso = c(
...
# Consolidação dos dados de 2017
SE2017 <- rbind(
...
# MRT6: Litoral Norte e Baixo São Francisco
...
write.csv2(SETEMPORAL, file = "C:/Users/jodom/OneDrive/Área de Trabalho/SETEMPO.csv")
