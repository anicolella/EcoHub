...
# Tabela 2: Sertão do São Franscisco - PE
...
# Tabela 4: Sertão do São Franscisco - BA
...
MRT_I_Metropolitana_2019 <- data.frame(
  mrt = "I - Metropolitana",
  tipologia_de_uso = c("Uso indefinido (mÃ©dia geral do MRT)", "Terra de exploraÃ§Ã£o mista"),
  nivel = c(0, 1),
...
MRT_IX_Triunfo_2019 <- data.frame(
  mrt = "IX - Triunfo",
...
MRT_V_Agreste_Oeste_2019 <- data.frame(
  mrt = "V - Agreste Oeste",
  tipologia_de_uso = c("Uso indefinido (mÃ©dia geral do MRT)", "Terra de exploraÃ§Ã£o mista", "Terra de pecuÃ¡ria", "Terra de exploraÃ§Ã£o mista/Sem recursos hÃ­dricos", "Terra de pecuÃ¡ria/pastagem nativa sem recursos hÃ­dricos", "Terra de pecuÃ¡ria/pastagem nativa com recursos hÃ­dricos", "Terra de pecuÃ¡ria/pastagem plantada sem recursos hÃ­dricos", "Terra de pecuÃ¡ria/pastagem plantada com recursos hÃ­dricos", "Terra de exploraÃ§Ã£o mista/Sem recursos hÃ­dricos (Alagoinha)", "Terra de exploraÃ§Ã£o mista/Sem recursos hÃ­dricos (ItaÃ­ba)", "Terra de pecuÃ¡ria/Com pastagem nativa sem recursos hÃ­dricos (Ãguas Belas)", "Terra de pecuÃ¡ria/Com pastagem nativa sem recursos hÃ­dricos (Belo Jardim)", "Terra de pecuÃ¡ria/Com pastagem nativa sem recursos hÃ­dricos (Iati)", "Terra de pecuÃ¡ria/Com pastagem nativa sem recursos hÃ­dricos (ItaÃ­ba)", "Terra de pecuÃ¡ria/Com pastagem nativa sem recursos hÃ­dricos (JataÃºba)"),
  nivel = c(0, 1, 1, 2, 2, 2, 2, 2, 3, 3, 3, 3, 3, 3, 3),
  vti_media = c(4525.8, 2445.59, 4679.8, 2408.03, 2658.45, 7083.52, 6561.74, 7109.99, 1903.64, 3117.62, 2895.13, 2431.83, 2638.29, 3253.27, 1872.48),
  vti_minimo = c(2834.43, 1890.18, 3027.51, 1838.41, 2002.62, 5352.22, 4503.04, 5717.52, 1590.41, 2948.46, 2589.22, 1804.05, 1990.95, 2697.05, 1048.23),
  ...
  vtn_media = c(4039.09, 1925.03, 4147.62, 1817.27, 2399.18, 6249.23, 5203.3, 6351.62, 1445.09, 2986.67, 2790.41, 1877.44, 2402.37, 2737.08, 1729.01),
  ...
  vtn_maximo = c(5567.44, 2383.29, 5596.71, 2279.4, 2995.99, 7861.0, 6826.91, 7618.27, 1806.7, 3120.65, 3089.62, 2314.94, 3125.28, 3123.52, 2580.75)
)
...
# Script de Preços Referenciais de Terras (PPR) - Ano 2019
...
# Tabela de Preços Referenciais de Terras (PPR) - RAMT/2022
...
# MRT 2 - Sertão do São Francisco Pernambucano
...
# Tabela de Preços Referenciais de Terras (PPR) - RAMT/2024
...
write.csv2(PETEMPORAL, file = "C:/Users/jodom/OneDrive/Área de Trabalho/PETEMPO.csv")
