...
# Tabela de Preços Referenciais de Terras - SR-21/AMAΡΑ - 2016
MRT_Leste_2016 <- data.frame(
  mrt = "Leste (SR-21/Amapá)",
  tipologia_de_uso = c(
...
MRT_Oeste_2016 <- data.frame(
  mrt = "Oeste (SR-21/Amapá)",
  tipologia_de_uso = c(
    "Uso indefinido (média geral)",
    "Agricultura",
    "Floresta",
...
# Tabela de Preços Referenciais de Terras para o MRT Leste (2019)

# Tabela de Preços Referenciais de Terras para o MRT Oeste (2019)
MRTOeste_2019 <- data.frame(
...
#Junção
AP16 <- rbind(MRT_Leste_2016, MRT_Oeste_2016)

AP16$ano <-2016
AP19 <- rbind(MRTLeste_2019, MRTOeste_2019)
AP19$ano <- 2019
AP23 <- rbind(MRTLeste_VTI_2023, MRTOeste_VTI_2023)
AP23$ano <- 2023
...
write.csv2(APTEMPORAL, "APTEMPO.csv")
