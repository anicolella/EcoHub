...
# Zona: ZONA DA MATA PARAIBANA (Alhandra, Baía da Traição, Bayeux, Caaporã, Cabedelo, Capim, Conde, Cruz do Espírito Santo, João Pessoa, Juripiranga, Lucena, Mamanguape, Marcação, Mataraca, Pedras de Fogo, Pitimbu, Rio Tinto, Santa Rita, São Miguel de Taipu, Sapé e Sobrado.)
...
MRT2_2018 <- data.frame(
  ...
  nivel = c(1, 1, 1, 2, 2, 2, 1, 1, 2, 2, 2, 2, 2, 2, 1, 1),
...
PB2018 <- rbind(
  MRT1_2018, MRT2_2018, MRT3_2018, MRT4_2018, MRT5_2018
)

# Tabela da ZONA DA MATA PARAIBANA
...
# Tabela do AGRESTE E BREJO PARAIBANO
...
# Tabela do CARIRI E CURIMATAÚ PARAIBANO
...
# MRT01: ZONA DA MATA PARAIBANA - 2021
...
# MRT02: AGRESTE E BREJO PARAIΒΑΝΟ - 2021
...
# MRT03: CARIRI E CURIMATAÚ PARAIBANO - 2021
...
# Consolidar todos os data.frames em um único
PB2021 <- rbind(MRT01_2021, MRT02_2021, MRT03_2021, MRT04_2021, MRT05_2021)

# Tabela 1: ZONA DA MATA PARAIBANA
MRT_ZONA_DA_MATA_PARAIBANA_2022 <- data.frame(
  mrt = "ZONA DA MATA PARAIBANA",
  tipologia_de_uso = c(
    "TODAS AS TIPOLOGIAS (média geral)",
    "Agrícola",
...
# Tabela 2: AGRESTE E BREJO PARAIBANO
...
# Tabela 3: CARIRI E CURIMATAU PARAIBANO
MRT_CARIRI_E_CURIMATAU_PARAIBANO_2022 <- data.frame(
  mrt = "CARIRI E CURIMATAÚ PARAIBANO",
  tipologia_de_uso = c(
    "TODAS AS TIPOLOGIAS (média geral)",
    "Pecuária",
...
# Tabela 3: CARIRI E CURIMATAÚ PARAIBANO
...
write.csv2(PBTEMPORAL, file = "C:/Users/jodom/OneDrive/Área de Trabalho/PBTEMPO.csv")
