...
# Carrega a biblioteca dplyr para a consolidação final
library(dplyr)
...
MRT_Centro_Norte_II_2016 <- data.frame(
  mrt = "Centro-Norte II",
...
# MRT VI: Centro-Leste
MRT_Centro_Leste_2016 <- data.frame(
  mrt = "Centro-Leste",
...
MRT_Centro_Oeste_2016 <- data.frame(
  mrt = "Centro-Oeste",
  tipologia_de_uso = c("Uso Indefinido (Média geral)", "Pecuária", "Exploração Mista"),
  nivel = c(0, 1, 1),
...
MRT_Vitoria_e_Entorno_2016 <- data.frame(
...
# MRT X: Sudoeste I
MRT_Sudoeste_I_2016 <- data.frame(
  mrt = "Sudoeste I",
...
# MRT XI: Sudoeste II
MRT_Sudoeste_II_2016 <- data.frame(
  mrt = "Sudoeste II",
...
# MRT XII: Litoral Sul
MRT_Litoral_Sul_2016 <- data.frame(
  mrt = "Litoral Sul",
...
ES16 <- rbind(
  MRT_Norte_2016,
  MRT_Nordeste_2016,
  MRT_Centro_Norte_I_2016,
  MRT_Noroeste_2016,
  MRT_Centro_Norte_II_2016,
  MRT_Centro_Leste_2016,
  MRT_Centro_Oeste_2016,
  MRT_Serrano_2016,
  MRT_Vitoria_e_Entorno_2016,
  MRT_Sudoeste_I_2016,
  MRT_Sudoeste_II_2016,
  MRT_Litoral_Sul_2016,
  MRT_Sul_2016
)
...
# MRT V: Centro-Norte II
MRT_Centro_Norte_II_2018 <- data.frame(
  mrt = "Centro-Norte II",
...
# MRT VI: Centro-Leste
MRT_Centro_Leste_2018 <- data.frame(
  mrt = "Centro-Leste",
...
# MRT VII: Centro-Oeste
MRT_Centro_Oeste_2018 <- data.frame(
  mrt = "Centro-Oeste",
...
# MRT IX: Vitória e Entorno
MRT_Vitoria_e_Entorno_2018 <- data.frame(
  mrt = "Vitória e Entorno",
  tipologia_de_uso = c("Uso Indefinido (Média geral)", "Pecuária"),
  nivel = c(0, 1),
...
# MRT X: Sudoeste I
MRT_Sudoeste_I_2018 <- data.frame(
  mrt = "Sudoeste I",
...
# MRT XI: Sudoeste II
MRT_Sudoeste_II_2018 <- data.frame(
  mrt = "Sudoeste II",
...
# MRT XII: Litoral Sul
MRT_Litoral_Sul_2018 <- data.frame(
  mrt = "Litoral Sul",
...
ES18 <- rbind(
  MRT_Norte_2018,
  MRT_Nordeste_2018,
  MRT_Centro_Norte_I_2018,
  MRT_Noroeste_2018,
  MRT_Centro_Norte_II_2018,
  MRT_Centro_Leste_2018,
  MRT_Centro_Oeste_2018,
  MRT_Serrano_2018,
  MRT_Vitoria_e_Entorno_2018,
  MRT_Sudoeste_I_2018,
  MRT_Sudoeste_II_2018,
  MRT_Litoral_Sul_2018,
  MRT_Sul_2018
)
...
# MRT V: Centro-Norte II
MRT_Centro_Norte_II_2021 <- data.frame(
  mrt = "Centro-Norte II",
...
# MRT VI: Centro-Leste
MRT_Centro_Leste_2021 <- data.frame(
  mrt = "Centro-Leste",
...
# MRT VII: Centro-Oeste
MRT_Centro_Oeste_2021 <- data.frame(
  mrt = "Centro-Oeste",
...
# MRT IX: Vitória e Entorno
MRT_Vitoria_e_Entorno_2021 <- data.frame(
  mrt = "Vitória e Entorno",
  tipologia_de_uso = c("Uso Indefinido (Média Geral)", "Pecuária"),
  nivel = c(0, 1),
...
# MRT X: Sudoeste I
MRT_Sudoeste_I_2021 <- data.frame(
  mrt = "Sudoeste I",
...
# MRT XI: Sudoeste II
MRT_Sudoeste_II_2021 <- data.frame(
  mrt = "Sudoeste II",
  tipologia_de_uso = c("Uso Indefinido (Média Geral)", "Agricultura", "Pecuária", "Exploração Mista"),
  nivel = c(0, 1, 1, 1),
...
# MRT XII: Litoral Sul
MRT_Litoral_Sul_2021 <- data.frame(
  mrt = "Litoral Sul",
...
ES21 <- rbind(
  MRT_Norte_2021,
  MRT_Nordeste_2021,
  MRT_Centro_Norte_I_2021,
  MRT_Noroeste_2021,
  MRT_Centro_Norte_II_2021,
  MRT_Centro_Leste_2021,
  MRT_Centro_Oeste_2021,
  MRT_Serrano_2021,
  MRT_Vitoria_e_Entorno_2021,
  MRT_Sudoeste_I_2021,
  MRT_Sudoeste_II_2021,
  MRT_Litoral_Sul_2021,
  MRT_Sul_2021
)
...
# MRT III: Centro-Norte I
MRT_Centro_Norte_I_2022 <- data.frame(
  mrt = "Centro-Norte I",
...
# MRT V: Centro-Norte II
MRT_Centro_Norte_II_2022 <- data.frame(
  mrt = "Centro-Norte II",
...
# MRT VI: Centro-Leste
MRT_Centro_Leste_2022 <- data.frame(
  mrt = "Centro-Leste",
...
# MRT VII: Centro-Oeste
MRT_Centro_Oeste_2022 <- data.frame(
  mrt = "Centro-Oeste",
...
# MRT IX: Vitória e Entorno
MRT_Vitoria_e_Entorno_2022 <- data.frame(
  mrt = "Vitória e Entorno",
...
# MRT X: Sudoeste I
MRT_Sudoeste_I_2022 <- data.frame(
  mrt = "Sudoeste I",
...
# MRT XI: Sudoeste II
MRT_Sudoeste_II_2022 <- data.frame(
  mrt = "Sudoeste II",
...
# MRT XII: Litoral Sul
MRT_Litoral_Sul_2022 <- data.frame(
  mrt = "Litoral Sul",
  tipologia_de_uso = c("Geral", "Pecuária", "Pecuária Diversos"),
  nivel = c(0, 1, 2),
...
ES22 <- rbind(
  MRT_Norte_2022,
  MRT_Nordeste_2022,
  MRT_Centro_Norte_I_2022,
  MRT_Noroeste_2022,
  MRT_Centro_Norte_II_2022,
  MRT_Centro_Leste_2022,
  MRT_Centro_Oeste_2022,
  MRT_Serrano_2022,
  MRT_Vitoria_e_Entorno_2022,
  MRT_Sudoeste_I_2022,
  MRT_Sudoeste_II_2022,
  MRT_Litoral_Sul_2022,
  MRT_Sul_2022
)
...
# MRT V: Centro-Norte II
MRT_Centro_Norte_II_2024 <- data.frame(
  mrt = "Centro-Norte II",
...
# PPR/SR(ES)/Nº05/2024/MRT VI – CENTRO-LESTE
MRT_Centro_Leste_2024 <- data.frame(
  mrt = "VI - CENTRO-LESTE",
  tipologia_de_uso = c(
    "Geral",
    "Agrícola",
...
# MRT VII: Centro-Oeste
MRT_Centro_Oeste_2024 <- data.frame(
  mrt = "Centro-Oeste",
...
# MRT IX: Vitória e Entorno
MRT_Vitoria_e_Entorno_2024 <- data.frame(
  mrt = "Vitória e Entorno",
  tipologia_de_uso = c("Geral", "Pecuária", "Pecuária Diversos"),
  nivel = c(0, 1, 2),
...
# MRT X: Sudoeste I
MRT_Sudoeste_I_2024 <- data.frame(
  mrt = "Sudoeste I",
  tipologia_de_uso = c(
    "Geral",
    "Agrícola",
...
# MRT XI: Sudoeste II
MRT_Sudoeste_II_2024 <- data.frame(
  mrt = "Sudoeste II",
  tipologia_de_uso = c("Geral", "Agrícola", "Pecuária", "Agrícola-Café", "Pecuária-Diversos"),
  nivel = c(0, 1, 1, 2, 2),
...
# MRT XII: Litoral Sul
MRT_Litoral_Sul_2024 <- data.frame(
  mrt = "Litoral Sul",
  tipologia_de_uso = c("Geral", "Pecuária", "Pecuária Diversos"),
  nivel = c(0, 1, 2),
...
ES24 <- rbind(
  MRT_Norte_2024,
  MRT_Centro_Norte_I_2024,
  MRT_Noroeste_2024,
  MRT_Centro_Norte_II_2024,
  MRT_Centro_Oeste_2024,
  MRT_Serrano_2024,
  MRT_Vitoria_e_Entorno_2024,
  MRT_Sudoeste_I_2024,
  MRT_Sudoeste_II_2024,
  MRT_Litoral_Sul_2024,
  MRT_Sul_2024
)
...
write.csv2(ESTEMPO, file = "C:/Users/jodom/OneDrive/Área de Trabalho/ESTEMPO.csv")
